...
insert into LEETCODE.LEETCODE.Employee (id, name, salary, managerId) values ('3', 'Sam', '60000', 'None');
insert into LEETCODE.LEETCODE.Employee (id, name, salary, managerId) values ('4', 'Max', '90000', 'None');